...
| ------------- | ------------- |
| [Taguette](https://www.taguette.org/) | Es una herramienta de software de código abierto diseñada para facilitar el análisis cualitativo de datos. Es especialmente útil para investigadores, académicos y cualquier persona que necesite codificar y analizar textos. | Funciona como aplicación web, instalación en servidor o en computadora local. Su uso optimiza los procesos de análisis de datos no estructurados en la investigación | Enfoque cualitativo | Los resultados del análisis pueden ser exportados en formatos como CSV, PDF, hojas de cálculo y documentos de texto. Es especialmente útil para el análisis de datos no estructurados, como texto, audio, video, y otros formatos de archivo. Taguette es compatible con varios formatos de archivo, incluyendo PDF, Word, texto, HTML, EPUB, MOBI, Open Documents y Rich Text Files. | Es una herramienta  sencilla, ya que es de gran ayuda para tener tu información de una manera organizada. 
